      ...
      <div className="portfolio">
        <div className="caja">
          ...
          <div className="caja-image">
            <a href="https://ecommerce-nine-psi-92.vercel.app/" target="_blank">
              <img
                src="./restaurant.PNG"
                alt="error"
          ...
          <div className="caja-texto">
            ...
            usuarios podrán seleccionar sus platillos favoritos y agregarlos al
            carrito con facilidad
        ...
        <div className="caja">
          ...
          <div className="caja-texto">
            Es una plataforma increíble que te permitirá disfrutar de tus videos
            favoritos, descubrir contenido nuevo y conectarte con una comunidad
            apasionada de creadores. Es una opción perfecta si buscas una
            experiencia sencilla y directa para ver tus videos favoritos y
